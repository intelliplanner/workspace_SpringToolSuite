...
public class EncryptionDecryptionUtil {
	...
	public String encrypt(String passphrase, String plaintext) {
		try {
			...
			String aesPassword = (byteToHex(ivbytes) + "::" + byteToHex(saltbytes) + "::"
					+ new Base64().encodeAsString(encrypted));
	...
	public static String getDecryptedString(String encString) {
		...
		String password = aesUtil.decrypt(decryptedPassword.split("::")[1], decryptedPassword.split("::")[0],
				"0123456789123456", decryptedPassword.split("::")[2]);
		return password;
	}
...
//    	System.out.println(decrypt); 
		String encrypt = getEncryptedString("Test@123");
