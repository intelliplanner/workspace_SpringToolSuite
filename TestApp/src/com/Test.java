...
public class Test {
	...
	public static void main(String s[]) {
		...
		String regexStr = "[\\s]*[0-9]*[0-9]+"; // Regex to be matched

		// Step 1: Compile a regex via static method Pattern.compile(), default is
		// case-sensitive
		Pattern pattern = Pattern.compile(regexStr);
		// Pattern.compile(regex, Pattern.CASE_INSENSITIVE); // for case-insensitive
		// matching
